...
app.add_middleware(
    CORSMiddleware,
    # set to "*" to allow all origins or replace with a list of allowed origins
    allow_origins=origins,
    allow_credentials=True,
    # set to "*" to allow all methods or replace with a list of allowed methods
    allow_methods=["*"],
    # set to "*" to allow all headers or replace with a list of allowed headers
    allow_headers=["*"],
)
